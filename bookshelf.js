function Book(img, description) {
	return React.createElement("td", null, 
		  			React.createElement("img", {src: img, width: "100px"}, null),
		  ...
		  React.createElement("table", {className: "bookshelf-table"}, 
	  		React.createElement("tbody", null, 
			  	React.createElement("tr", null, 
			  		Book("images/tdd.jpeg","I've started this and I'm excited to learn more about how the 3 steps of TDD lead to great software."),
			  		Book("images/continuous_delivery.jpeg","Continuous Integration and Continuous Delivery have been done in different ways at the companies I've worked. I look forward to reading through this one to see if there are best practices that can be followed for CD, no matter which technologies or tools are being used."),
	  				Book(
	  					"images/essential_scrum.jpeg", 
